...
public class SortingAlgorithm {
    ...
    public void Test1() {
        ...
        for (int i = 0; i < testTimes; i++) {
            int[] arr = generateRandomPositiveUnsortedArray(5, 100);
        ...
        System.out.println("Test time\t" + testTimes);
        System.out.println("Fail time\t" + failTimes + "\n");
    }
    ...
    public void Test3() {
        System.out.println(testName.getMethodName() + " Merge Sorty implemented by using two extra array");
        int testTimes = 2;
        int failTimes = 0;
        for (int i = 0; i < testTimes; i++) {
            int[] arr = generateRandomUnsortedArray(5, 100);
    ...
    public void Test4() {
        ...
        System.out.println("Test times\t" + testTime);
        System.out.println("Fail times\t" + failTime + "\n");
    }

    //save temp clip of element from input array to optimize space complexity
    //optimize space complexity o(n0
    int[] helperArr;
    ...
    public void Test5() {
        ...
        System.out.println("Test times\t" + testTimes);
        System.out.println("Fail times\t" + testTimes + "\n");

    }
    //Quick sort algorithm which chooses the mid element as pivot
    ...
    //counting sort is a sorting algorithm based on keys between a specific range. It works by counting the frequency of
    //every object appears. TC: O(n)
    @Test
    public void Test6() {
    ...
    /*
    bucket sort is a sorting algorithm that works by distributing the elements of an array into a number of bucket
    then sort each bucket individually. It demonstrates a bucket sort by using an array of ArrayList, then sue insertiong sort when put every element
    into bucket
     */
    @Test
    public void Test7() {
        ...
        for (int i = 0; i < testTimes; i++) {
            ...
            arr = new int[]{6, 2, 7, 89, 50, 46, 11, 44, 16, 41};
            System.out.println("Before sorting:" + Arrays.toString(arr));
